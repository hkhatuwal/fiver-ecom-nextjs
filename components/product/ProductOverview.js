    ...
    return (
        <div className={'flex flex-col lg:flex-row lg:px-40 mt-32 lg:h-[65vh]'}>
            ...
            <div className="w-full lg:w-6/12 lg:h-80 p-5 py-10 flex flex-col gap-y-3 items-start">
                <h1 className={'text-4xl text font-bold khula-family'}>{product.title}</h1>
                ...
                <div className={'flex flex-col lg:flex-row gap-2 justify-start items-start'}>
                    <div className={'flex flex-row gap-2'}>
                        ...
                        <div
                            className={'border border-green_dark text-white p-3 rounded-full w-10 h-10 flex justify-center items-center'}>
                ...
                <div>
                    <ul className={'flex flex-col gap-y-3'}>
                        {product.features.map((feature) => {
                            return <li className={'flex flex-row gap-x-2 items-center'} key={feature.title}>
                                <DotIndicator/>
                                <p>{feature.title}</p>
                            </li>
                        })}
