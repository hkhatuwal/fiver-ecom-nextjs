...
const NavbarLight = () => {
    ...
    return (
        <nav className="absolute flex items-center justify-between flex-wrap lg:px-40  px-4    py-5  w-full z-10 top-0 ">
            ...
            <div className={`w-full flex-grow lg:flex lg:items-center lg:w-auto lg:bg-none  h-screen lg:h-auto  pt-6 lg:pt-0 ${isVisible?'bg-green_dark absolute top-[10vh] left-0 z-50':'hidden'}`}
                 id="nav-content">
