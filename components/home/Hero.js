    ...
    return (
        <div className={'lg:px-40 md:px-8 py-16  md:pt-32 md:pb-12   '}>
            ...
            <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-y-2 ">
                ...
                <div className={`left w-full md:w-5/12  flex justify-center flex-col items-end select-none anim-r-to-l ${isLoaded ? 'loaded' : ''} `}>

                    <Swiper modules={[Autoplay]} autoplay={{
                        delay: 1500,
                        disableOnInteraction: false,
                    }}   loop={true} onSwiper={setSwiper} className="mySwiper w-full h-full lg:w-[80%] lg:h-[80%]">
                ...
                <div className={`right w-full  md:w-7/12 flex flex-col gap-5 items-start px-2 anim-l-to-r  ${isLoaded ? 'loaded' : ''}`}>
