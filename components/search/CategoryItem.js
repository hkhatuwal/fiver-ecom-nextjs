...
const CategoryItem = ({image,isActive,title,slug}) => {
    ...
    return (
        <Link href={"/search/"+slug}>
            <div className={' rounded-lg border border-green_dark  p-4 px-14 bg-cover bg-no-repeat flex flex-col justify-center items-center hover:bg-green_dark/30'} style={{backgroundImage:isActive && "url('/assets/images/categories/selected-category-bg.png')"}}>
